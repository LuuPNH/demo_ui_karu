...
class RowLastInTable extends StatelessWidget {
      ...
      children: [
        Flexible(
          ...
          child: Container(
            ...
            margin: const EdgeInsets.only(bottom: 2.0, right: 1.0, top: 1.0, left: 2.0),
            height: 25,
        ...
        Flexible(
          ...
          child: Container(
            alignment: Alignment.centerRight,
            margin: const EdgeInsets.only(bottom: 2.0, left: 1.0, top: 1.0, right: 2.0),
            decoration: const BoxDecoration(
                color: Style.Colors.purple500,
                borderRadius:
